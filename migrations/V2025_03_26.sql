-- Create ingress_yahoo table for daily data
DROP SCHEMA IF EXISTS ingress_yahoo;
CREATE SCHEMA IF NOT EXISTS ingress_yahoo;

DROP TABLE IF EXISTS ingress_yahoo.companies_daily;
CREATE TABLE IF NOT EXISTS ingress_yahoo.companies_daily (
    symbol VARCHAR(65535) NOT NULL,
    load_timestamp_utc VARCHAR(65535) NOT NULL,
    previous_close VARCHAR(65535),
    open_price VARCHAR(65535),
    bid VARCHAR(65535),
    ask VARCHAR(65535),
...
DROP TABLE IF EXISTS ingress_yahoo.companies_weekly;
CREATE TABLE IF NOT EXISTS ingress_yahoo.companies_weekly (
    symbol VARCHAR(65535) NOT NULL,
    load_timestamp_utc VARCHAR(65535) NOT NULL,
...
-- Create ods_yahoo table for daily data
DROP SCHEMA IF EXISTS ods_yahoo;
CREATE SCHEMA IF NOT EXISTS ods_yahoo;

DROP TABLE IF EXISTS ods_yahoo.companies_daily;
CREATE TABLE IF NOT EXISTS ods_yahoo.companies_daily (
    symbol VARCHAR(16) NOT NULL,
    load_timestamp_utc TIMESTAMP NOT NULL,
    previous_close NUMERIC(9,2),
    open_price NUMERIC(9,2),
    bid VARCHAR(64),
    ask VARCHAR(64),
...
DROP TABLE IF EXISTS ods_yahoo.companies_weekly;
CREATE TABLE IF NOT EXISTS ods_yahoo.companies_weekly (
    symbol VARCHAR(16) NOT NULL,
    load_timestamp_utc TIMESTAMP NOT NULL,
